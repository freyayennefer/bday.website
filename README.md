...
<img src="https://raw.githubusercontent.com/freyayennefer/bday.website/main/bday.png" alt="Birthday Website Preview">
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/freyayennefer/bday.website.git
   cd bday.website
   ```
